...
def aroon_up(period_since_high: int, period: int = 25) -> float:
    """
...
def aroon_down(period_since_low: int, period: int = 25) -> float:
    """
...
def aroon_oscillator(period_since_high: int, period_since_low: int, period: int = 25) -> float:
    """
    ...
    """
    return aroon_up(period_since_high, period) - aroon_down(period_since_low, period)
